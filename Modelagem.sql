...
orcamento FLOAT(4),
urlImagem LONGTEXT, -- adição do campo permissao no tipo text por ser maior do que varchar...
fkEmpresa INT, FOREIGN KEY (fkEmpresa) REFERENCES empresa (idEmpresa) ON DELETE CASCADE,
...
('Samuel Luciano', 'samuelDev@gmail.com', 'samual123', 'Dev Frontend', 'Tech', 1),
('Rafael Efgham', 'rafael@gmail.com', 'rafael123', 'Analista de Banco de Dados', 'Tech', 1),
('Pedro Ueda', 'pedro@gmail.com', 'pedro123', 'Analista Backend', 'Tech', 1),
('Stephanie Gomes', 'stephanie@gmail.com', 'ster123', 'PM', 'Negócios', 1);

INSERT INTO projeto (descricao, orcamento, fkEmpresa, fkResponsavel) VALUES
('Sistema de Gestão Hospitalar', 250.0, 1, 1),
('Plataforma E-commerce', 120.0, 1, 3),
('App de Monitoramento Ambiental', 300.0, 1, 2),
('Sistema da Human Consulting', 5000, 1, 1);

INSERT INTO sprint (descricao, dtInicio, dtFim, fkProjeto) VALUES
('Sprint de elicitação de requisitos e conhecimento da empresa', '2025-03-01', '2025-03-31', 1),
('Sprint para desenvolvimento do sistema e homologação', '2025-04-01', '2025-04-30', 1),
('Sprint para inicio de testes unitários e entrega do projeto', '2025-05-01', '2025-06-01', 1);
