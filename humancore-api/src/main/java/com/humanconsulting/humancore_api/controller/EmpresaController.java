...
public class EmpresaController {
    ...
    @Operation(summary = "Cadastrar uma nova empresa", description = "Esse endpoint cria uma nova empresa no sistema")
    @ApiResponses(value = {
    ...
    @Operation(summary = "Listar todas as empresas", description = "Esse endpoint retorna uma lista com todas as empresas cadastradas")
    ...
    @Operation(summary = "Buscar empresa por ID", description = "Esse endpoint retorna os detalhes de uma empresa específica com base no ID fornecido")
    @ApiResponses(value = {
    ...
    @Operation(summary = "Deletar uma empresa", description = "Esse endpoint remove uma empresa do sistema com base no ID fornecido")
    @ApiResponses(value = {
    ...
    @Operation(summary = "Atualizar dados de uma empresa", description = "Esse endpoint atualiza os dados de uma empresa existente")
    @ApiResponses(value = {
