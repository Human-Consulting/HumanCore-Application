...
public class AutenticacaoFilter  extends OncePerRequestFilter {
    ...
    public AutenticacaoFilter(LoadUserByUsernameUseCase loadUserByUsername, GerenciadorTokenJwt jwtTokenManager) {
    ...
    protected void doFilterInternal(HttpServletRequest request, HttpServletResponse response, FilterChain filterChain) throws ServletException, IOException {
        ...
        if (Objects.nonNull(requestTokenHeader) && requestTokenHeader.startsWith("Bearer ")) {
            ...
            try {
                ...
                LOGGER.info("[FALHA AUTENTICACAO] - Token expirado, usuário: {} - {}",
    ...
    private void addUsernameInContext(HttpServletRequest request, String username, String jwtToken) {
        UserDetails userDetails = loadUserByUsername.execute(username);
