...
public class EmailNotifierAdapter implements EmailNotifier {
    ...
    public EmailNotifierAdapter(JavaMailSender emailSender) {
    ...
    public void update(Tarefa tarefa, Sprint sprintEntrega, Projeto projetoEntrega, Usuario tarefaResponsavel, Usuario projetoResponsavel, LoginResponseDto responsavelProjeto, LoginResponseDto responsavelEntrega) {
        ...
        String assunto = "Impedimento no Projeto: " + projetoEntrega.getDescricao();
    ...
    public void cadastro(Usuario usuario) {
        List<String> email = Collections.singletonList(usuario.getEmail());
    ...
    public void codigo(UsuarioEnviarCodigoRequestDto usuarioEnviarCodigoRequestDto) {
        ...
        email.add(usuarioEnviarCodigoRequestDto.getEmail());
        String conteudo = (String.format("""
                            <div
                                    style="
