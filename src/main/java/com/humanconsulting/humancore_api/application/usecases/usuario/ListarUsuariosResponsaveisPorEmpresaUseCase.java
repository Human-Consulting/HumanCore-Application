...
public class ListarUsuariosResponsaveisPorEmpresaUseCase {
    private final UsuarioRepository usuarioRepository;
    private final UsuarioResponseMapper usuarioResponseMapper;

    public ListarUsuariosResponsaveisPorEmpresaUseCase(UsuarioRepository usuarioRepository, UsuarioResponseMapper usuarioResponseMapper) {
    ...
    public PageResult<UsuarioResponseDto> execute(Integer idEmpresa, int page, int size) {
        PageResult<Usuario> usuarios = usuarioRepository.findByFkEmpresaAndPermissaoNot(idEmpresa, page, size);
